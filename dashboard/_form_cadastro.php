<?php
// dashboard/_form_cadastro.php

// Carrega as patologias (assumindo que $patologias_list está definido em dashboard.php)
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-10 mx-auto">
            <h1 class="text-center mb-4">Cadastro de Paciente</h1>
            ...
            <form method="POST" action="dashboard.php" id="form-paciente">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php
                                        $idade_atual = calcular_idade($data_nascimento_val);
                                    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="kit_lpp" name="kit_lpp (Lesão Por Pressão)">
                                                <option value="" disabled>Selecione...</option>
                ...
                <div class="d-flex justify-content-center gap-2 mt-4">
                    ...
                    <a href="../pacientes/exibir_dados.php" class="btn btn-secondary">Ver Dados Cadastrados</a>
                    <a href="importar_dados.php" class="btn btn-info">Importar Dados</a>
                    </div>
            </form>
        </div>
    </div>
